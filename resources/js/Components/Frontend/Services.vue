...
<template>
    <section id="services" class="section  bg-sky-200
      dark:bg-blue-900 py-32">
    ...
    y: 0,
            ...
            <div class="py-8 grid lg:grid-cols-4 gap-8">
              ...
              text-[28px]
            ">
                        <svg xmlns="http://www.w3.org/2000/svg" class="dark:text-white h-24 w-24" fill="none" viewBox="0 0 24 24"
