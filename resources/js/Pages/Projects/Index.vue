        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-end m-2 p-2">
                    <Link href="/projects/create" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded-md">New Project
                    </Link>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr v-for="project in projects.data" :key="project.id"
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <Link method="delete" as="button" type="button" :href="route('projects.destroy', project.id)"
